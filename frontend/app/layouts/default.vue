  ...
  <div class="min-h-screen bg-brand-bg text-brand-text flex flex-col font-sans selection:bg-brand-gold selection:text-brand-cocoa-dark overflow-x-hidden">
    ...
    <header class="sticky top-0 z-40 bg-brand-bg/90 backdrop-blur-md border-b border-brand-gold/10 transition-all duration-300">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <!-- Logo -->
        <NuxtLink to="/" class="flex items-center group max-h-14">
          <img src="/logo.jpg" alt="Cocora Delights" class="h-10 sm:h-12 md:h-14 w-auto object-contain mix-blend-multiply bg-transparent" />
        </NuxtLink>
      ...
      >
        <div v-if="isMobileMenuOpen" class="fixed top-0 right-0 min-h-[100dvh] w-4/5 max-w-sm bg-brand-bg shadow-2xl z-50 md:hidden flex flex-col overflow-y-auto touch-pan-y" style="-webkit-overflow-scrolling: touch; padding-bottom: env(safe-area-inset-bottom);">
          <div class="px-4 py-6 flex items-center justify-between">
            <img src="/logo.jpg" alt="Cocora Delights" class="h-8 w-auto object-contain pl-2 mix-blend-multiply" />
    ...
    <footer class="bg-brand-cocoa-dark text-brand-cream border-t border-brand-gold/15 py-12 md:py-16 px-4 sm:px-6 lg:px-8 font-serif">
      <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
        <!-- Brand Story Column -->
        <div class="space-y-6">
          <NuxtLink to="/" class="inline-block mb-4 bg-brand-cream/90 backdrop-blur-sm rounded-2xl px-4 py-2 hover:bg-brand-cream transition-colors duration-300">
            <img src="/logo.jpg" alt="Cocora Delights" class="h-10 sm:h-12 w-auto object-contain mix-blend-multiply" />
          </NuxtLink>
          ...
          <div class="flex items-center space-x-4 pt-2">
            <a href="https://www.instagram.com/cocoradelights?igsh=MWNwaXZlMmp6ZThqaQ%3D%3D&igsi=MWNwaXZlMmp6ZThqaQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="text-brand-gold hover:text-brand-cream transition-colors duration-300">
            ...
            <a href="https://www.tiktok.com/@cocora.delights" target="_blank" rel="noopener noreferrer" aria-label="TikTok" class="text-brand-gold hover:text-brand-cream transition-colors duration-300">
